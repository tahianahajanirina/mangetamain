...
TASK_CONFIG = {
    "time_prediction": {
        ...
        "key_features": [
            "n_steps", "n_ingredients", "cooking_verb_count",
            "equipment_count", "avg_step_length", "steps_word_count"
        ]
    },
    "nutrition_tagging": {
        ...
        "key_features": [
            "calories", "protein_pdv", "carbs_pdv", "total_fat_pdv",
            "sugar_pdv", "sodium_pdv", "saturated_fat_pdv"
        ]
    }
}
...
FEATURE_CONFIG = {
    ...
    "cooking_verbs": {
        ...
        'steam', 'broil', 'blend', 'mix', 'whisk', 'chop', 'dice',
        'mince', 'slice', 'marinate', 'season', 'toss'
    },
    "equipment_terms": {
        'oven', 'stove', 'microwave', 'blender', 'mixer', 'processor',
        'pan', 'pot', 'skillet', 'bowl', 'dish', 'sheet', 'rack',
    ...
    "ingredient_categories": {
        ...
        'has_eggs': ['egg'],
        'has_vegetables': ['tomato', 'onion', 'garlic', 'pepper', 'spinach', 'broccoli', 'carrot'],
